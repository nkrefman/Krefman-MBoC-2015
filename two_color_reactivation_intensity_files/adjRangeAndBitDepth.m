...
% GFP images should say 'GFP' in the filename
% mCherry images should say 'mCherry' in the filename
...
for k=1:numConditions
    ...
    tempsstrains = {'/25C/01 - WT', '/25C/02 - nup53KO','/25C/03 - nup60KO','/25C/04 - mlp1KO mlp2KO','/37C/01 - WT','/37C/02 - kar3-64','/37C/03 - dam1-1'};
    ...
    for j=1:numTimepoints
        ...
        % stacks.
        times = {'/00min','/05min','/10min','/15min','/20min','/30min'};
